          ...
          <LinearGradient
            ...
            <View style={{flexDirection: 'row',justifyContent: 'space-around',margin:10}}>
             ...
             <View style={{flexDirection:'column'}}>
               ...
               <Text style={{fontSize: 9,color: '#FFFFFF',marginBottom: 13}}>dr. Rina Agustina</Text>
               <Text style={{fontSize: 9,color: '#FFF9AA'}}>Klinik / RS Anda</Text>
               <Text style={{fontSize: 9,color: '#FFFFFF'}}>RS. National Hospital</Text>
             </View>
            </View>
          </LinearGradient>
        </View>
...
const styles = StyleSheet.create({
    gradient: {width: 343, height: 143, margin: 17},
  teks: {
    fontSize: 12,
